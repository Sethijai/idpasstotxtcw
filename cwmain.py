...
async def account_login(bot: Client, m: Message):
    ...
    url = "https://spec.iitschool.com/api/v1/login-other"
    data = {
        "deviceType": "android",
        "password": "Rohit@123",
        "deviceIMEI": "",
    ...
    if "*" in raw_text:
      ...
      token = raw_text
    html1 = s.get("https://spec.iitschool.com/api/v1/comp/my-batch?&token=" + token).json()
    ...
    html2 = s.get("https://spec.iitschool.com/api/v1/comp/batch-topic/"+raw_text2+"?type=class&token="+token).json()
    ...
    for data in topicid:
        ...
        ffx = s.get("https://spec.iitschool.com/api/v1/comp/batch-detail/"+raw_text2+"?redirectBy=mybatch&topicId="+tid+"&token="+token).json()
...
#                  p =xvv[z]
            ...
            #scraper = cloudscraper.create_scraper()
            html4 = s.get("https://spec.iitschool.com/api/v1/comp/batch-detail/"+raw_text2+"?redirectBy=mybatch&topicId="+t+"&token="+token).content
            ff = json.loads(html4)
                ...
                for data in vv:
                    ...
                    if bcvid.startswith("62"):
                        try:
                            ...
                            #print(video_url)
                            #scraper = cloudscraper.create_scraper()
                            html5 = s.get("https://spec.iitschool.com/api/v1/livestreamToken?type=brightcove&vid="+vidid+"&token="+token).content
                    ...
                    #await m.reply_text(cc)
                        ...
                        try:
                            ...
                            #print(video_url)
                            #scraper = cloudscraper.create_scraper()
                            html8 = s.get("https://spec.iitschool.com/api/v1/livestreamToken?type=brightcove&vid="+vidid+"&token="+token).content
