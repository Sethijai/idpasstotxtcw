...
async def account_login(bot: Client, m: Message):
    ...
    login_url = "https://spec.apnikaksha.net/api/v2/login-other"  # Indentation corrected here
    ...
    batch_url = "https://spec.apnikaksha.net/api/v2/my-batch"
    ...
    topic_url = "https://spec.apnikaksha.net/api/v2/batch-topic/" + raw_text2 + "?type=class"
...
#                  p =xvv[z]
            ...
            #gettting all json with diffrent topic id https://spec.iitschool.com/api/v1/comp/batch-detail/100?redirectBy=mybatch&topicId=2099&token=07e14af4156c909f6477e07539f89abc97cf9ddb
            scraper = cloudscraper.create_scraper()
            html4 = scraper.get("https://spec.apnikaksha.net/api/v2/comp/batch-detail/"+raw_text2+"?redirectBy=mybatch&topicId="+t+"&token="+token).content
            ff = json.loads(html4)
                ...
                for data in vv:
                    ...
                    if bcvid.startswith("62"):
                        try:
                            ...
                            #print(video_url)
                            scraper = cloudscraper.create_scraper()
                            html5 = scraper.get("https://spec.apnikaksha.net/api/v2/livestreamToken?type=brightcove&vid="+vidid+"&token="+token).content
                        ...
                        try:
                            ...
                            #print(video_url)
                            scraper = cloudscraper.create_scraper()
                            html8 = scraper.get("https://spec.apnikaksha.net/api/v2/livestreamToken?type=brightcove&vid="+vidid+"&token="+token).content
...
#                         await prog.delete (True)
    ...
    try:
        ...
        if raw_text5 == 'y':
            scraper = cloudscraper.create_scraper()
            html7 = scraper.get("https://spec.apnikaksha.net/api/v2/comp/batch-notes/"+raw_text2+"?topicid="+raw_text2+"&token="+token).content
